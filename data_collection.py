...
def main():
    ...
    gpr_path = os.path.join(RAW_DIR, "All_Historical_Data_Separately",
                            "Geopolitical Risk Index Daily.csv")  # Adjust if needed
    ...
    def extract_news_features_abc(news_df, keywords):
        ...
        # )
        ### Got rid of TextBlob because correlation with gprd was equal 0 ###

        # VADER gives compound score (better for news)
        news_df['sentiment'] = news_df['headline_text'].apply(
